...
def _check_evidence(requirement: dict[str, Any], _config: PreflightConfig) -> dict[str, Any]:
    required = (
        ...
        "packages/spawnledger/pyproject.toml",
        "packages/spawnledger/spawnledger/ledger.py",
        "packages/spawnledger/spawnledger/reset.py",
        "packages/spawnledger/tests/test_spawnledger.py",
