...
DIFFUSION_WORKER_EXPERIMENTAL_ENABLED = _env_bool(
    "QLH_DIFFUSION_WORKER_EXPERIMENTAL_ENABLED", False,
)
DIFFUSION_WORKER_DATA_PLANE_BASE_URL = _env_first(
    "QLH_DIFFUSION_WORKER_DATA_PLANE_BASE_URL", default="",
)
