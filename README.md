...
- [reasonix-codex-bridge 全面审计与多次实测报告](docs/reasonix-codex-bridge全面审计与多次实测报告-2026-09-13.md) — 真实覆盖 MCP 控制面、inspect、plan、受控写入/回滚、checkpoint/resume 与 ACP-06；结论为可作为受限文件型低价替代，shell/测试/网络、跨进程 ACP 恢复与自主多阶段编排仍待后续票
