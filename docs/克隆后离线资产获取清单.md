...
| **SD 1.5 五资产离线包** | ~15 GB（5 包） | 图像生成工作区（原版/90s/IP-Adapter/inpaint/InstructPix2Pix） | 官方离线资产包（[SD 1.5 离线资产包计划](SD%201.5离线资产包与签名源站发布计划.md)）或 `python scripts/download_sd15.py` | 图像实验 |
